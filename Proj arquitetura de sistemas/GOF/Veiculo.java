public abstract class Veiculo{
    ...
    //Padrão Template Method onde aguarda de outras classes, possui o esqueleto do algoritmo montado mas não faz tudo sozinha. 

    // Padrão Strategy onde os atributos das classes são organizados para receber o valor indicado
